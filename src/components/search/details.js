...
function Details({ theData }) {
  ...
  return (
    <div className="details">
      ...
      <p className="text-white py-2">{theData.blog}</p>
      <div className="score d-flex text-white align-items-center justify-content-between">
        <div>
          <span>Repos</span>
          <h5>{theData.public_repos}</h5>
        </div>
        <div>
          <span>Followers</span>
          <h5>{theData.followers}</h5>
        </div>
        <div>
          <span>Following</span>
          <h5>{theData.following}</h5>
        </div>
      </div>
      <div className="info text-white d-flex justify-content-around mt-3">
        <div className="info1">
          {theData.location !== null ? (
            <div className="d-flex">
              <svg
                style={{ fill: "white", marginRight: "15px" }}
                height="20"
                width="14"
